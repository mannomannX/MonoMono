...
# ==============================================================================
# Aktualisiert den Workflow in einem bestehenden Fusions-Repo auf die neueste,
# intelligenteste Version (z.B. mit README-Generierung).
# ==============================================================================
...
# --- Extrahiere bestehende Konfiguration ---
...
# --- Generiere den neuen, verbesserten Workflow-Inhalt ---
    ...
    steps:
      ...
      - name: Create intelligent README
        run: |
          ...
          echo "" >> README.md
          echo "Dieses Repository ist eine automatisch generierte Zusammenführung, erstellt von MonoMono." >> README.md
          echo "" >> README.md
...
if ! git diff-index --quiet HEAD; then
    ...
    echo "✔ Workflow ist bereits auf dem neuesten Stand."
fi
cd - >/dev/null
rm -rf "$TEMP_DIR"

echo "✅ Workflow für '$FUSION_REPO' erfolgreich aktualisiert!"
echo "   Führe 'monomono-update $FUSION_REPO' aus, um die Änderungen zu sehen."